...
namespace StreamsDemo
{
    ...
    public static class StreamsExtension
    {
        ...
        {
            Validation(sourcePath, destinationPath);
        ...
        public static int InMemoryByByteCopy(string sourcePath, string destinationPath)
        {
            ...
            reader.Dispose();
            MemoryStream stream = new MemoryStream(block, 0, block.Length);
        ...
        private static void Validation(string sourcePath, string destinationPath)
        {
            if (sourcePath == null || destinationPath == null)
            {
                throw new ArgumentNullException("Invalid input data. Enter sourcePath and destinationPath.");
            }
